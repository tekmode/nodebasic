...
var url = "mongodb://localhost:27017/assessmentportal";
...
`
    ...
    MongoClient.connect(url1, { useNewUrlParser: true }, function(err, db) {
          if (err) throw err;
          var dbo = db.db("assessmentportal");
         dbo.collection("reviews").group(
            {
              key: { 'course.courseTeacher':1,'course.courseName':1 },
